...
class Ahorcado {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			while (cant_intentos > 0 && !juegoGanado(progreso_palabra)) {
				...
				if (armarProgreso(letras, progreso_palabra, letra, palabra_elegida)) {
					JOptionPane.showMessageDialog(null, "Has Acertado!" + "\nTe quedan " + cant_intentos + " intentos.",
							"Intentos", JOptionPane.DEFAULT_OPTION, new ImageIcon(Ahorcado.class.getResource("/img/acertaste.jpg")));
			...
			if (juegoGanado(progreso_palabra)) {
				...
				JOptionPane.showMessageDialog(null,
						...
						JOptionPane.DEFAULT_OPTION, new ImageIcon(Ahorcado.class.getResource("/img/perdiste.png")));
		...
		case 2:
			JOptionPane.showMessageDialog(null,
					"Bienvenido/a : " + nombre + " elegiste adivina el numero." + "\n -    Tenes 5 vidas."
